...
export default function HomeSeccionThree() {
    return (
        <section className="py-5 bg-gray-500 overflow-hidden">
            <div className="max-w-9/10 mx-auto">
                <h2 className="text-center text-xl md:text-2xl font-semibold mb-6 text-white"> Grupo comercial CODEXRV - Aliados comerciales </h2>
